 ...
 *
 * @param {string} dataType - the dataType from the object returned by getDataType.ts
 * @param {string} name - the name from the object returned by getDataType.ts
 * @returns {BaseState} - instance of the state class from the data type with corresponding name
 */
