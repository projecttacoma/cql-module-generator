...
export type Conditional =
  ...
  | AgeConditional
  | DateConditional
  | SocioeconomicStatusConditional
  | RaceConditional
  | SymptomConditional
  | ObservationConditional
  | VitalSignConditional
  | ActiveAllergyConditional
  | ActiveConditionConditional
  | ActiveMedicationConditional
  | ActiveCarePlanConditional
  | PriorStateConditional
